...
These functionalities are available from a desktop interface \labelindexref{Figure}{img:BNMMainPanel}.


\fig[scale=0.5]{src/img/BNMMainPanel.png}{img:BNMMainPanel}{Business Network Modeling Interface} 
