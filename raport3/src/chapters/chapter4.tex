...
\fig[scale=0.2]{src/img/university.png}{img:university}{Participant - Organization}
...
\fig[scale=0.2]{src/img/profile2.png}{img:studentprofile2}{Asset - Updated data of a StudentProfile}
