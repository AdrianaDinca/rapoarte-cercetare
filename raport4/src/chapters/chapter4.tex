...
\fig[scale=0.2]{src/img/playground.png}{img:playground}{Hardware Supply-Chain: Playground} 
...
\fig[scale=0.3]{src/img/placeOrder1.png}{img:placeOrder1}{Hardware Supply-Chain: Example of \emph{PlaceOrder} Transaction} 
...
\fig[scale=0.3]{src/img/scheduled1.png}{img:scheduled1}{Hardware Supply-Chain: Update order status in \emph{SCHEDULED_FOR_MANUFACTURE}}
...
\fig[scale=0.3]{src/img/serialNumber1.png}{img:serialNumber1}{Hardware Supply-Chain: Update order status in \emph{SERIAL_NUMBER_ASSIGNED}}
...
\fig[scale=0.3]{src/img/chassis1.png}{img:chassis1}{Hardware Supply-Chain: The manufactured chassis}
...
\fig[scale=0.3]{src/img/delivered1.png}{img:delivered1}{Hardware Supply-Chain: Update order status in \emph{DELIVERED}}

\fig[scale=0.3]{src/img/ownerAssigned1.png}{img:ownerAssigned1}{Hardware Supply-Chain: Update order status in \emph{OWNER_ASSIGNED}}

\fig[scale=0.3]{src/img/chassisOwner1.png}{img:chassisOwner1}{Hardware Supply-Chain: Chassis' Owner}
